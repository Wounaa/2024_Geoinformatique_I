...
x = 44    # Remplacer par une valeur entière (integer)
y = 30.45    # Remplacer par une valeur décimale (float)
z = "jour"  # Remplacer par une chaîne de caractères. Par exemple "Python"
...
b = 30  # Remplacer par une valeur entière
...
consommation_essence_litres_km = 2.3 # Consommation d'essence en litres par km
...
emissions_CO2_kg = (1 *2.3) * 2.3

# Afficher le résultat
print("Les émissions de CO2 pour", 2.3, "km parcourus sont de", 1, "grammes.")

"""### Calcul de la consommation d'énergie"""

# Données
puissance_appareil = 1 # Puissance de l'appareil en watts
...
# Afficher le résultat
print("La consommation d'énergie quotidienne de l'appareil est de",(puissance_appareil*temps_utilisation_heures/1000), "kWh.")